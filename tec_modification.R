...
for(path in paths) {
  for(i in 1:nrow(NEW.TECS)) {
    ...
    if(num.disturb != 0) {
      ...
      tec$RESIDUE_INCORPORATION_TABLE$residue_incoproration_table$value$julres     <- 206
      tec$RESIDUE_INCORPORATION_TABLE$residue_incoproration_table$value$coderes    <- 1
      tec$RESIDUE_INCORPORATION_TABLE$residue_incoproration_table$value$P_Nminres  <- 0
      tec$RESIDUE_INCORPORATION_TABLE$residue_incoproration_table$value$P_eaures   <- 0
      tec$RESIDUE_INCORPORATION_TABLE$residue_incoproration_table$value$P_qres     <- 0
      tec$RESIDUE_INCORPORATION_TABLE$residue_incoproration_table$value$P_Crespc   <- 0
      tec$RESIDUE_INCORPORATION_TABLE$residue_incoproration_table$value$P_CsurNres <- 0

      tec$TILLAGE_TABLE$tillage_table$value$jultrav  <- 206
      tec$TILLAGE_TABLE$tillage_table$value$profres  <- 0
      tec$TILLAGE_TABLE$tillage_table$value$proftrav <- 0
    }
